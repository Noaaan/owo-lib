...
public class UwuOptionalNetExample {
    ...
    public static void init() {
        if (FabricLoader.getInstance().getEnvironmentType() == EnvType.SERVER || SERVER_CHANNEL_IN_CLIENT) {
            var serverChannel = OwoNetChannel.createOptional(new ResourceLocation("uwu", "optional_server"));
            ...
            if (CLIENT_CHANNEL_IN_SERVER) {
                var clientChannel = OwoNetChannel.createOptional(new ResourceLocation("uwu", "optional_client"));
