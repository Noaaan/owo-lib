...
public class OwoItemGroupLoader implements ModDataConsumer {
    ...
    public void acceptParsedFile(ResourceLocation id, JsonObject json) {
        var targetGroupId = new ResourceLocation(GsonHelper.getAsString(json, "target_group"));
        ...
        tabsArray.forEach(jsonElement -> {
            ...
            var texture = new ResourceLocation(GsonHelper.getAsString(tabObject, "texture", ItemGroupTab.DEFAULT_TEXTURE.toString()));

            var tag = TagKey.create(Registries.ITEM, new ResourceLocation(GsonHelper.getAsString(tabObject, "tag")));
            var icon = BuiltInRegistries.ITEM.get(new ResourceLocation(GsonHelper.getAsString(tabObject, "icon")));
        ...
        buttonsArray.forEach(jsonElement -> {
            ...
            var texture = textureId == null
                    ...
                    : new ResourceLocation(textureId);
