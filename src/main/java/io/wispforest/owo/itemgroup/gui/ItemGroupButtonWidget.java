...
public class ItemGroupButtonWidget extends Button {
    ...
    public void renderWidget(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        context.blit(this.definition.texture(), this.getX(), this.getY(), this.baseU, this.isHoveredOrFocused() || this.isSelected ? this.height : 0, this.width, this.height, 64, 64);
